          ...
          <div style={{ width:"800px",alignItems: "center", border: "2px solid black", borderRadius: "10px", alignContent: "center", padding: "40px" }} className='bg-gray-600 w-3/5'>
            <form onSubmit={handleSubmit}>
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                <label style={{ color: "black", fontWeight: "500", fontSize: "20px", fontFamily: "sans-serif" }} htmlFor="name">Enter your Titile</label>
              ...
              <br />
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                <label  style={{ color: "black", fontWeight: "500", fontSize: "20px", fontFamily: "sans-serif" }} htmlFor="description">Description your poerty</label>
                <input  type="text" style={{ width: "50%", borderRadius: "5px" , height:"100px"}} name="description" value={input.description || ''} onChange={handleInput} />
              </div>
              <br />
              <br />
              <div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
